 ...
 *  Simulando la respuesta de objetos Solicitudes
...
function crearSolicitud(req, res, next) { // POST v1/solicitudes?mascota_id=021abo59c96b90a02344...
  ...
  console.log("dentro de crearSolicitud");
  console.log(req.query.mascota_id);
...
/*function obtenerSolicitudes(req, res) {
  ...
  console.log("dentro")
  var solicitud1 = new Solicitud(1, '1', '300820', '1', '2', 'En proceso');
  var solicitud2 = new Solicitud(2, '1', '300820', '1', '3', 'En proceso');
  res.send([solicitud1, solicitud2])
}

function obtenerSolicitud(req, res) {
  // Simulando dos usuarios y respondiendolos
  var solicitud1 = new Solicitud(req.params.id, '1', '300820', '1', '2', 'En proceso');
  res.send(solicitud1)
} 
*/
